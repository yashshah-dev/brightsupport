...
export default function AboutUsPage() {
  return (
    <div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-14">
              ...
              <a
                ...
                download
                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#1E4D8C] to-[#2563EB] hover:from-[#0F2D4D] hover:to-[#1E4D8C] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-elegant-lg"
              >
                <Download size={20} />
                Download Brochure
              </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
              {/* Who We Are */}
              <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-8 shadow-elegant border border-sky-100 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="text-[#1E4D8C] mb-5">
                  <Users size={48} />
                </div>
              ...
              {/* What We Do */}
              <div className="bg-gradient-to-br from-cyan-50 to-sky-50 rounded-2xl p-8 shadow-elegant border border-cyan-100 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="text-[#38BDF8] mb-5">
                  <Heart size={48} />
                </div>
              ...
              {/* How We Do It */}
              <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl p-8 shadow-elegant border border-red-100 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="text-[#DC3545] mb-5">
                  <Award size={48} />
                </div>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-gradient-to-br from-slate-50 to-sky-50/30 rounded-2xl p-10 shadow-elegant border border-slate-100">
                <div className="flex items-center gap-3 mb-6">
                  <Target size={40} className="text-[#1E4D8C]" />
                ...
                <div className="bg-gradient-to-br from-sky-50 to-blue-50 border-l-4 border-[#1E4D8C] p-7 mt-8 rounded-r-xl">
      ...
      {/* Values Section */}
      <section className="py-20 bg-gradient-to-br from-slate-50 to-sky-50/30" style={{ contentVisibility: 'auto', containIntrinsicSize: '800px' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-elegant text-center border border-slate-100 hover:border-sky-200 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-br from-sky-100 to-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                  <Award className="text-[#1E4D8C]" size={36} />
                </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-elegant text-center border border-slate-100 hover:border-cyan-200 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-br from-cyan-100 to-sky-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                  <Target className="text-[#38BDF8]" size={36} />
                </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-elegant text-center border border-slate-100 hover:border-red-200 hover:shadow-elegant-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-br from-red-100 to-rose-100 rounded-2xl flex items-center justify-center mx-auto mb-5">
                  <Heart className="text-[#DC3545]" size={36} />
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Melbourne', 'Shepparton', 'Brisbane', 'Sydney', 'Telehealth'].map((location) => (
                <span
                  key={location}
                  className="bg-gradient-to-br from-sky-50 to-blue-50 text-[#1E4D8C] px-8 py-4 rounded-full font-semibold border border-sky-200 hover:border-sky-300 hover:shadow-elegant transition-all duration-300"
                >
                  {location}
                </span>
              ))}
