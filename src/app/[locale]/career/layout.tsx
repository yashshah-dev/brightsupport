...
export const metadata: Metadata = {
    ...
    description: 'Join our Bright Support team in Shepparton. We are looking for dedicated Support Workers, Registered Nurses, and Physiotherapists. Competitive pay, flexible hours, and career growth opportunities.',
    openGraph: {
